...
$parentSectionParser = new SectionParser($url, $parent_section_params);
$sections = $parentSectionParser->get_section_list();
show_progress(); //debug
unset($parentSectionParser);
...
$exclude_brands = array(
    'Vimtag', 'Ivideon', ' Tiandy', 'Nobelic', 'BAS-IP', 'CTV',
    'ДАКСИС', 'Cyfral'
);
